...
public class CombinedClient3 extends CombinedClient implements Member3{
	
	static String hostName="localhost";
	static int iterations=500;
	
	public CombinedClient3(HalloweenCommandProcessor hcp, ClientConsensusObject mechanism) throws NotBoundException, UnknownHostException, IOException{
		super(hcp, mechanism);
	}
	...
	public static void main(String args[]) throws NotBoundException, UnknownHostException, IOException{
		...
		CombinedClient client = new CombinedClient3(hcp, mechanism);
	}
